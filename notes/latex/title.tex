...
\begin{titlepage} % Suppresses headers and footers on the title page
        ...
        \AtTextUpperLeft{%
            \put(185,12){
                \parbox[b][\paperheight]{\paperwidth}{% parbox
                    ...
                    \fbox{                                
                        \includegraphics[keepaspectratio=false,width=50pt,height=50pt]{img/title/title_db.png}
                        }
                    } % transparent
                } % parbox
            } % put
	...
	{\LARGE Introduction to Structured Query Language (SQL) (Coursera)
    \\ \Large University Of Michigan\\} % Title
